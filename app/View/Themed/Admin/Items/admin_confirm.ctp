    ...
    <?php echo $this->Form->create('Item', array('type' => 'file', 'url' => 'regist')); ?>
      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
          <tr>
            ...
            <?php echo $this->Form->hidden('Item.title', array('value' => $data['Item']['title'])); ?>
          </tr>
          <tr>
            <th>価格</th>
          ...
          <tr>
            ...
            <td>
                <?php
                    echo $data['Item']['sale_type'] == 0 ? '販売中':'sould out';
                ?>
            </td>
            <?php echo $this->Form->hidden('Item.sale_type', array('value' => $data['Item']['sale_type'])); ?>
          </tr>
